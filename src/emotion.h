...
{
    public:
        EmotionClassifier(Logger gLogger, DataType dtype, const string uffFile, const string engineFile, int batchSize,
        ...
        // void featureMatching(cv::Mat &image, vector<string> &detections);
